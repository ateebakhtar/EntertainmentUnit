...
public class movie extends AppCompatActivity {
    ...
    Spinner w;
    Spinner w1;
    String [] list = {"All","Fiction","Action","Horror","Comedy"};
    ...
    public void NewRecycle(){
        ...
        MyApplication s = new MyApplication();
         int p =  s.getSomeVariable();
        System.out.println(p);
        adapter adapter1 = new adapter(this,mImageUrls,mNames,1,p);
